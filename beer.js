(function () {
  ...
  function beerFunc () {
    ...
    var beerChoices = {
      ...
      wheat: ['3 Floyds Gumballhead', "Lagunitas A Little Sumpin' Sumpin'", "Barrier's Bumble", "Blue Lobster's Stalkholm Syndrome", "Parish's Canebrake", "Alpine's Willy Vanilly", "Hacker Pschorr", "Harpoon Hefeweizen"],
